...
/// JNM UI's under construction desktop screen.
class JNMUnderConstructionDesktopScreen extends StatelessWidget {
  ...
  const JNMUnderConstructionDesktopScreen({
    ...
    this.image =
        'packages/jnm_ui/assets/images/under_construction_illustration.png',
    super.key,
  });
