...
/// JNM UI's 404 desktop screen.
class JNM404DesktopScreen extends StatelessWidget {
  ...
  const JNM404DesktopScreen({
    ...
    this.image = 'packages/jnm_ui/assets/images/not_found_illustration.png',
    super.key,
  });
