...
/// JNM UI's pagination footer component widget for Desktop.
class JNMDesktopPaginationFooter extends StatelessWidget {
  /// Widget's height
  final double height;
  ...
  const JNMDesktopPaginationFooter({
    required this.currentPage,
    required this.numPages,
    required this.onPressedPrevious,
    required this.onPressedNext,
    required this.onPressedPage,
    this.previousIconAssetName = JNMIcons.chevron_left_double,
    this.nextIconAssetName = JNMIcons.chevron_right_double,
    this.height = 40,
    super.key,
  });
    ...
    return AspectRatio(
      ...
      child: Container(
        decoration: BoxDecoration(
          color: page == currentPage ? JNMColors.primary100 : null,
  ...
  Widget _buildDots() => const AspectRatio(
        aspectRatio: 1,
        child: JNMIcon(JNMIcons.dots_horizontal),
      );
