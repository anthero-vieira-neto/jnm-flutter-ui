...
/// Shows [JNMSnackBar] on top of the current screen.
///
/// This method is similar to [showJNMSnackBar] but it uses default values
/// specified for Desktop screen.
OverlayEntry showJNMSnackBarDesktop({
...
/// JNM UI's SnackBar component widget.
class JNMSnackBar extends StatefulWidget {
  ...
  @override
  State<JNMSnackBar> createState() => _JNMSnackBarState();
}

class _JNMSnackBarState extends State<JNMSnackBar>
