...
class JNMDraggableBottomSheet extends StatelessWidget {
  /// Bottom sheet title.
  final String title;
  ...
  const JNMDraggableBottomSheet({
    ...
    this.footerHeight = JNMButtonHeights.lg,
    this.footerWidget,
            ...
            child: Container(
              ...
              decoration: const BoxDecoration(
                borderRadius: BorderRadius.vertical(
                  top: Radius.circular(JNMBorderRadius.md),
                ),
                color: Colors.white,
              ),
              child: Stack(
...
/// [JNMDraggableBottomSheet] header widget.
///
