...
class JNMLinearProgressIndicator extends ProgressIndicator {
  /// Border radius.
  ...
  const JNMLinearProgressIndicator({
    ...
    super.backgroundColor = JNMColors.grey200, // FIXME
    super.color = JNMColors.success,
    super.valueColor,
    super.semanticsLabel,
    super.semanticsValue,
    this.minHeight = 8.0,
    this.borderRadius = JNMBorderRadius.sm,
  }) : assert(minHeight == null || minHeight > 0);

  @override
  State<JNMLinearProgressIndicator> createState() =>
      _JNMLinearProgressIndicatorState();
...
class _JNMLinearProgressIndicatorState
    extends State<JNMLinearProgressIndicator>
  ...
  @override
  void didUpdateWidget(JNMLinearProgressIndicator oldWidget) {
  ...
  Widget _buildIndicator(
    ...
    return widget._buildSemanticsWrapper(
      ...
      child: Container(
        ...
        child: CustomPaint(
          painter: _JNMLinearProgressIndicatorPainter(
...
class _JNMLinearProgressIndicatorPainter extends CustomPainter {
  const _JNMLinearProgressIndicatorPainter({
  ...
  @override
  bool shouldRepaint(_JNMLinearProgressIndicatorPainter oldPainter) {
