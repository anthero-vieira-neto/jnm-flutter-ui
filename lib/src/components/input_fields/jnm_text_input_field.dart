...
/// Possible size values for [JNMTextInputField].
enum JNMTextInputFieldSize {
  sm, // Small
  md, // Medium
}
...
class JNMTextInputField extends StatefulWidget {
  ...
  const JNMTextInputField({
    ...
    this.suffixIconColor = JNMColors.neutral300,
    this.suffixErrorIconColor = JNMColors.danger,
    this.controller,
    this.initialValue,
    this.keyboardType,
    ...
    this.suffixErrorIconAssetName = JNMIcons.alert_circle,
    this.onTapSuffix,
    this.focusNode,
  ...
  @override
  State<JNMTextInputField> createState() => _JNMTextInputFieldState();
}

class _JNMTextInputFieldState extends State<JNMTextInputField> {
        ...
        child: Padding(
          ...
          child: Center(
            child: SvgPicture.asset(
              'packages/jnm_ui/assets/images/mastercard.svg',
              height: 34.0,
            ),
          ),
        ),
