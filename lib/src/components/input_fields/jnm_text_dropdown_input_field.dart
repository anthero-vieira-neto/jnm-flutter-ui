...
/// JNM UI's text input field.
///
/// This component was made as closely as possible to [TextFormField].
class JNMTextDropdownInputField<T> extends StatefulWidget {
  ...
  final List<JNMDropdownInputFieldOption<T>> dropdownOptions;
  ...
  const JNMTextDropdownInputField({
  ...
  @override
  State<JNMTextDropdownInputField<T>> createState() =>
      _JNMTextDropdownInputFieldState<T>();
}

class _JNMTextDropdownInputFieldState<T>
    extends State<JNMTextDropdownInputField<T>> {
  final GlobalKey _widgetKey = GlobalKey();
  bool _isFocused = false;
  late FocusNode _focusNode;
  late TextEditingController _dropdownController;
  JNMDropdownInputFieldOption<T>? _dropdownValue;
                ...
                decoration: InputDecoration(
                  ...
                  suffixIcon: Material(
                    borderRadius: const BorderRadius.only(
                      topRight: Radius.circular(JNMBorderRadius.sm),
                      bottomRight: Radius.circular(JNMBorderRadius.sm),
                    ),
  ...
  PopupMenuEntry _buildDropdownOption(
    ...
    JNMDropdownInputFieldOption<T> option,
  ) {
