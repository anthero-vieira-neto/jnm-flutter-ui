...
/// [JNMStackedHorizontalBarChart]'s data point class.
class JNMStackedHorizontalBarChartData<T> {
  ...
  JNMStackedHorizontalBarChartData({
    required this.label,
    required this.value,
    required this.color,
    this.customData,
...
class JNMStackedHorizontalBarChart extends StatelessWidget {
  ...
  const JNMStackedHorizontalBarChart({
