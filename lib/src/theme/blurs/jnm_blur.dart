...
/// Alignment.center)
class JNMBlur extends StatelessWidget {
  const JNMBlur({
    required this.child,
    this.blur = JNMBlurSizes.md,
...
/// Extension of [JNMBlur] on [Widget] to blur it's child
/// same as a [JNMBlur] widget but you can use this as an extension on
/// any widget which you want to have a blur effect
/// blur is the value of blur effect, higher the blur more the blur effect
extension BlurExtension on Widget {
  JNMBlur blurred({
    double blur = JNMBlurSizes.md,
